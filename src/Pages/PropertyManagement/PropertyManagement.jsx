...
const PropertyManagement = () => {
    ...
    return (
        <div className='m-6'>
            <div className='bg-black px-4 py-20 md:px-8 lg:px-16 xl:px-32 lg:py-24 xl:py-32 rounded-2xl'>
            ...
            <div className='mt-6 xl:w-[1200px] mx-auto bg-white p-6 rounded-full'>
                <div className='flex flex-wrap gap-2'>
                    {tabs.map(tab => (
                        <button
                            key={tab.id}
                            className={`flex-1 px-2 py-2 gap-1 text-base font-semibold rounded-full shadow ${activeTab === tab.id ? 'bg-black text-white' : 'text-gray-600'} focus:outline-none`}
