...
const OurProcess = () => {
    ...
    return (
        <div className="mx-2">
            ...
            <div className="lg:w-[546px] mx-auto mb-8">
                <h1 className="text-3xl 2xl:text-5xl text-center font-medium mb-4">Find your dream house as easy as 1, 2, 3</h1>
                <p className="text-center secondary-text">Lorem ipsum dolor sit amet consectetur. Sit ut gravida aenean potenti. Metus in eu vel morbi dui nunc tellus. Non a massa maecenas massa.</p>
            </div>
            <div className="2xl:w-[1200px] mx-auto 2xl:flex justify-between mb-16 2xl:mb-0">
                <div className=" w-full  2xl:w-[537px] mx-auto mt-10">
                    <div className="border-b bg-white shadow rounded-2xl">
                        ...
                        >
                            <span className=" text-xl 2xl:text-2xl font-medium text-gray-800 text-left">1. Search for your favorite   house in your location</span>
                ...
                <div className="relative  space-y-6">
                    <div>
                        <img src={image} alt="" className=" w-full hidden 2xl:block" />
                    </div>
                    <div className="w-full 2xl:w-[360px] bg-[#f7f7f7] p-6 rounded-3xl shadow 2xl:absolute 2xl:top-1/3 2xl:-right-1/4">
                        <form className="relative mb-3">
                            <input type="text" name=" " placeholder='Choose your location' className="bg-[#fafafb] py-3 px-4 w-full rounded-full focus:outline-none" />
                        ...
                        <div className="mb-4">
                            ...
                            <h1 className="text-[12px]">Luxury Loft in San Francisco</h1>
