...
const PropertyBanner = () => {
    return (
        <div className='lg:m-6 '>
            <div className=' bg-black px-16 py-20 md:px-32 lg:p-40  lg:rounded-3xl relative mb-44 '>
                ...
                <form className='bg-white w-[940px] mx-auto p-6 rounded-3xl absolute left-1/4 mt-10'>
