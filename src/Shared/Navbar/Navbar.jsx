        ...
        <nav className='absolute  z-20 w-full xl:px-4  left-0 right-0'>
            ...
            >
                <ul className='space-y-4 text-black'>
                    ...
                    {
                        user ? <li><Link to="/admin" onClick={toggleDropdown} className='lock px-2 bg-[#990a05] text-white p-1  rounded duration-300 ease-in'>Dashboard</Link></li> : <li><Link to="/authpage" onClick={toggleDropdown} className='lock px-2 bg-[#990a05] text-white p-1  rounded duration-300 ease-in'>Login</Link></li>
                    }
                </ul>
